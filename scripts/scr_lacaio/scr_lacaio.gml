function lacaios(){
	var spr_lacaio = [spr_zumbi, spr_fantasma, spr_esqueleto, spr_mumia, spr_golem_z];
	var nome_lacaio = ["zumbi", "fantasma", "esqueleto", "mumia", "golem zumbi"];
	var vida = [10, 3, 5, 6, 50];
	var dano = [2.5, 0, 5, 3, 10];
	var velocid = [.3, .5, .5, .4, .2];
